...
namespace Cafe.DAO
{
    ...
    {
        private static NumberToText instance;

        public static NumberToText Instance
        {
            get { instance = new NumberToText(); return instance; }
            private set => instance = value;
        }
        private NumberToText() { }
        public string FuncNumberToText(float inputNumber, bool suffix = true)
        {
            char[] separator = { ',', '.' };
        ...
        public string IntNumberToText(int inputNumber, bool suffix = true)
        {
